...
TOPIC_POOL = [
    ...
    ("MacBook Air M3 vs Dell XPS 14: Best Ultraportable Laptop", "laptops",
     ["macbook-air", "dell-xps", "ultrabook", "apple-silicon", "intel", "laptop", "m3"],
     "Compare MacBook Air M3 and Dell XPS 14 for portability, performance, and display quality."),
    ("AirPods Pro 2 vs Sony WF-1000XM5: Best Wireless Earbuds", "earbuds",
     ["airpods-pro", "sony-wf", "noise-cancelling", "wireless-earbuds", "apple", "sony"],
     "AirPods Pro 2 vs Sony WF-1000XM5: Compare noise cancellation, sound quality, and battery life."),
    ("Samsung Galaxy Tab S9 FE vs iPad Air M1: Best Mid-Range Tablet", "tablets",
     ["samsung-galaxy-tab", "ipad-air", "tablet", "mid-range", "android", "ios"],
     "Samsung Galaxy Tab S9 FE vs iPad Air M1: Compare performance, display, and ecosystem."),
    ("Garmin Fenix 7X vs Suunto Vertical: Best Adventure Watch", "smartwatches",
     ["garmin-fenix", "suunto", "adventure-watch", "gps", "outdoor", "smartwatch"],
     "Garmin Fenix 7X vs Suunto Vertical: Compare durability, battery life, and navigation features."),
    ("Sony A7 IV vs Canon EOS R6 Mark II: Best Full-Frame Mirrorless Camera", "cameras",
     ["sony-a7", "canon-eos-r", "mirrorless", "full-frame", "camera", "photography"],
     "Sony A7 IV vs Canon EOS R6 Mark II: Compare autofocus, video capabilities, and lens ecosystem."),
    ("Logitech MX Mechanical vs Razer BlackWidow V4 Pro: Best Mechanical Keyboard", "keyboards",
     ["logitech-mx", "razer-blackwidow", "mechanical-keyboard", "wireless", "gaming", "productivity"],
     "Logitech MX Mechanical vs Razer BlackWidow V4 Pro: Compare typing feel, connectivity, and RGB lighting."),
    ("Logitech G Pro X Superlight 2 vs Razer Viper V2 Pro: Best Lightweight Gaming Mouse", "mice",
     ["logitech-g-pro", "razer-viper", "gaming-mouse", "wireless", "lightweight", "mouse"],
     "Logitech G Pro X Superlight 2 vs Razer Viper V2 Pro: Compare weight, sensor, and battery life."),
    ("Anker PowerCore 26800 vs Mophie Powerstation XL: Best Portable Charger", "chargers",
     ["anker-powercore", "mophie", "portable-charger", "power-bank", "usb-c", "battery"],
     "Anker PowerCore 26800 vs Mophie Powerstation XL: Compare capacity, charging speed, and portability."),
    ("Nintendo Switch OLED vs Steam Deck OLED: Best Handheld Gaming Console", "gaming-consoles",
     ["nintendo-switch", "steam-deck", "handheld", "gaming-console", "oled", "portable"],
     "Nintendo Switch OLED vs Steam Deck OLED: Compare game library, performance, and display quality."),
    ("Segway Ninebot Max G2 vs Xiaomi Electric Scooter 4 Pro: Best Commuter E-Scooter", "escooters",
     ["segway-ninebot", "xiaomi", "electric-scooter", "commuter", "escooter", "portable"],
     "Segway Ninebot Max G2 vs Xiaomi Electric Scooter 4 Pro: Compare range, speed, and build quality."),
    ("Samsung 990 Pro vs WD Black SN850X: Best NVMe SSD", "ssds",
     ["samsung-990-pro", "wd-black", "nvme-ssd", "storage", "gaming", "pc-build"],
     "Samsung 990 Pro vs WD Black SN850X: Compare read/write speeds, endurance, and thermal management."),
    ("Dell UltraSharp U2723QE vs LG 27UP850N: Best 4K USB-C Monitor", "monitors",
     ["dell-ultrasharp", "lg-27up", "4k-monitor", "usb-c", "ips", "monitor"],
     "Dell UltraSharp U2723QE vs LG 27UP850N: Compare color accuracy, connectivity, and ergonomics."),
    ("Apple HomePod 2 vs Sonos Era 300: Best Smart Speaker", "smart-home",
     ["apple-homepod", "sonos-era", "smart-speaker", "audio", "home-assistant", "speaker"],
     "Apple HomePod 2 vs Sonos Era 300: Compare sound quality, smart features, and ecosystem integration."),
    ("Netgear Nighthawk M6 vs Inseego MiFi X Pro 5G: Best Mobile Hotspot", "routers",
     ["netgear-nighthawk", "inseego", "mobile-hotspot", "5g", "router", "travel"],
     "Netgear Nighthawk M6 vs Inseego MiFi X Pro 5G: Compare speed, battery life, and carrier compatibility."),
    ("Shure MV7 vs Rode NT-USB+: Best USB Microphone for Podcasting", "microphones",
     ["shure-mv7", "rode-nt-usb", "usb-microphone", "podcasting", "audio", "microphone"],
     "Shure MV7 vs Rode NT-USB+: Compare sound quality, build, and ease of use for podcasters."),
    ("Dell XPS 15 vs MacBook Pro 14 M3: Best for Creative Professionals", "laptops",
     ["dell-xps", "macbook-pro", "creative-laptop", "m3", "intel", "laptop"],
     "Dell XPS 15 vs MacBook Pro 14 M3: Compare performance, display, and port selection for creatives."),
    ("Sony WH-1000XM5 vs Bose QuietComfort Ultra: Best Noise-Cancelling Headphones", "headphones",
     ["sony-wh", "bose-qc", "noise-cancelling", "headphones", "wireless", "audio"],
     "Sony WH-1000XM5 vs Bose QuietComfort Ultra: Compare ANC, comfort, and sound signature."),
    ("iPad Pro M4 vs Microsoft Surface Pro 10: Best 2-in-1 for Business", "tablets",
     ["ipad-pro", "surface-pro", "2-in-1", "business", "tablet", "productivity"],
     "iPad Pro M4 vs Microsoft Surface Pro 10: Compare performance, keyboard, and software for business use."),
    ("Apple Watch Series 9 vs Samsung Galaxy Watch 6: Best Smartwatch for iPhone Users", "smartwatches",
     ["apple-watch", "samsung-galaxy-watch", "smartwatch", "fitness", "health", "wearable"],
     "Apple Watch Series 9 vs Samsung Galaxy Watch 6: Compare health features, battery life, and app ecosystem."),
    ("Canon EOS R8 vs Sony A7C II: Best Compact Full-Frame Camera", "cameras",
     ["canon-eos-r", "sony-a7c", "full-frame", "compact", "camera", "travel"],
     "Canon EOS R8 vs Sony A7C II: Compare size, autofocus, and video features for travel photography."),
    ("Corsair K70 RGB Pro vs SteelSeries Apex Pro TKL: Best Gaming Keyboard", "keyboards",
     ["corsair-k70", "steelseries-apex", "gaming-keyboard", "mechanical", "rgb", "tkl"],
     "Corsair K70 RGB Pro vs SteelSeries Apex Pro TKL: Compare switch options, responsiveness, and software."),
    ("Razer DeathAdder V3 Pro vs Logitech G703 Lightspeed: Best Ergonomic Gaming Mouse", "mice",
     ["razer-deathadder", "logitech-g703", "gaming-mouse", "ergonomic", "wireless", "mouse"],
     "Razer DeathAdder V3 Pro vs Logitech G703 Lightspeed: Compare shape, weight, and sensor performance."),
    ("Anker 737 Power Bank vs Belkin BoostCharge Pro: Best 100W USB-C Power Bank", "chargers",
     ["anker-737", "belkin-boostcharge", "power-bank", "usb-c", "100w", "fast-charging"],
     "Anker 737 Power Bank vs Belkin BoostCharge Pro: Compare capacity, output ports, and charging speed."),
    ("PlayStation 5 Slim vs Xbox Series X: Best Console for 2024", "gaming-consoles",
     ["playstation-5", "xbox-series-x", "gaming-console", "4k", "gaming", "console"],
     "PlayStation 5 Slim vs Xbox Series X: Compare game library, performance, and exclusive titles."),
    ("Segway Ninebot KickScooter ES4 vs Razor E300: Best Electric Scooter for Teens", "escooters",
     ["segway-ninebot", "razor", "electric-scooter", "teen", "escooter", "commuter"],
     "Segway Ninebot KickScooter ES4 vs Razor E300: Compare speed, range, and safety features for teens."),
    ("Samsung T7 Shield vs SanDisk Extreme Pro Portable: Best Rugged External SSD", "ssds",
     ["samsung-t7", "sandisk-extreme", "external-ssd", "rugged", "portable", "storage"],
     "Samsung T7 Shield vs SanDisk Extreme Pro Portable: Compare durability, speed, and water resistance."),
    ("LG C4 OLED vs Samsung S90D QD-OLED: Best OLED TV for Gaming", "monitors",
     ["lg-c4", "samsung-s90d", "oled-tv", "gaming", "4k", "monitor"],
     "LG C4 OLED vs Samsung S90D QD-OLED: Compare picture quality, input lag, and HDR performance."),
    ("Amazon Echo Studio vs Apple HomePod: Best Smart Speaker for Music", "smart-home",
     ["amazon-echo", "apple-homepod", "smart-speaker", "music", "audio", "home-assistant"],
     "Amazon Echo Studio vs Apple HomePod: Compare sound quality, smart assistant, and music streaming."),
    ("TP-Link Deco X55 vs Netgear Orbi RBK762: Best Budget Mesh Router", "routers",
     ["tp-link-deco", "netgear-orbi", "mesh-router", "wi-fi-6", "budget", "router"],
     "TP-Link Deco X55 vs Netgear Orbi RBK762: Compare coverage, speed, and ease of setup."),
    ("Rode Wireless GO II vs DJI Mic 2: Best Wireless Lavalier Microphone", "microphones",
     ["rode-wireless-go", "dji-mic", "wireless-microphone", "lavalier", "video", "audio"],
     "Rode Wireless GO II vs DJI Mic 2: Compare range, battery life, and audio quality for content creators."),
    ("Lenovo ThinkPad X1 Carbon Gen 11 vs HP Elite Dragonfly G4: Best Business Laptop", "laptops",
     ["thinkpad-x1", "hp-elite-dragonfly", "business-laptop", "ultrabook", "productivity", "laptop"],
     "Lenovo ThinkPad X1 Carbon Gen 11 vs HP Elite Dragonfly G4: Compare build quality, keyboard, and security."),
    ("Bose QuietComfort Earbuds II vs Samsung Galaxy Buds2 Pro: Best ANC Earbuds", "earbuds",
     ["bose-qc", "samsung-galaxy-buds", "noise-cancelling", "earbuds", "wireless", "audio"],
     "Bose QuietComfort Earbuds II vs Samsung Galaxy Buds2 Pro: Compare ANC effectiveness and sound quality."),
    ("Google Pixel Tablet vs Amazon Echo Show 10: Best Smart Display", "tablets",
     ["google-pixel-tablet", "amazon-echo-show", "smart-display", "tablet", "home-assistant"],
     "Google Pixel Tablet vs Amazon Echo Show 10: Compare display quality, smart home features, and portability."),
    ("Garmin Vivoactive 5 vs Fitbit Versa 4: Best Affordable Smartwatch", "smartwatches",
     ["garmin-vivoactive", "fitbit-versa", "smartwatch", "fitness", "affordable", "health"],
     "Garmin Vivoactive 5 vs Fitbit Versa 4: Compare fitness tracking, battery life, and app ecosystem."),
    ("Sony FX3 vs Canon C70: Best Cinema Camera for Filmmakers", "cameras",
     ["sony-fx3", "canon-c70", "cinema-camera", "video", "filmmaking", "camera"],
     "Sony FX3 vs Canon C70: Compare video quality, low-light performance, and lens compatibility."),
]
